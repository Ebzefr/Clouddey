      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            <img src={logo} alt="Clouddey" className="h-8 mb-4" />
            <p className="text-gray-300 mb-4">
              Clouddey is a cloud storage service that helps you to store, share, and access your files from anywhere on any device.
            </p>
        ...
        <div className="border-t border-blue-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 Clouddey. All rights reserved.</p>
